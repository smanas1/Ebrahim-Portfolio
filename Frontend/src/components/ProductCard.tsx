  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700">
        <ImageSlider
          images={
            product.pictures || ["https://placehold.co/300x300?text=No+Image"]
          }
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center bg-green-50 dark:bg-green-950/30 rounded-lg p-2">
                ...
                <div className="min-w-0">
                  <p className="text-xs text-muted-foreground truncate font-sans uppercase tracking-tight">
                    Cost
                  </p>
        ...
        <CardFooter className="p-0 pt-2">
          <Button
            ...
            onClick={(e) => {
              ...
              window.open(
                `https://wa.me/8801750062927?text=${message}`,
                "_blank"
              );
            }}
          >
