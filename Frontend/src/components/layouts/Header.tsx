      ...
      subItems: [
        {
          ...
          items: [
            {
              label: "Sourcing from China",
              href: "/services/sourcing-china",
              tag: "Popular",
            },
            {
          ...
          items: [
            {
              ...
              href: "/services/pre-production-inspection",
            },
            {
              label: "During Production Inspection",
              href: "/services/during-production-inspection",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: "/services/lifestyle-photography",
            },
          ],
        },
      ],
    ...
    <>
      ...
      <div
        className={`text-sm py-2 px-4 ${
          theme === "dark"
            ? "bg-gradient-to-r from-emerald-900 to-emerald-700 text-white"
                  ...
                  {item.dropdown ? (
                    <div className="flex items-center gap-1 cursor-pointer group">
                      <span
                        ...
                        } font-medium group-hover:text-emerald-400 transition-colors`}
                      >
                        {item.label}
                      </span>
                      <ChevronDown
              ...
              <div className="md:col-span-1">
                ...
                <div
                  className={`bg-gradient-to-r ${
                    theme === "dark"
                      ? "from-emerald-900/50 to-emerald-700/50 border-emerald-800/50"
                      : "from-emerald-100 to-emerald-200/50 border-emerald-200/50"
