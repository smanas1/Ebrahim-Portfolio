...
const Contact = () => {
  ...
  return (
    <section className={`py-20 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-900 text-white'}`} id="contact">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12 rounded-2xl overflow-hidden shadow-xl">
            <div className={`lg:w-1/2 p-8 md:p-12 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
              <span className={`inline-block px-4 py-1 text-xs font-semibold ${theme === 'dark' ? 'bg-emerald-900 text-emerald-200' : 'bg-emerald-100 text-emerald-700'} rounded-full uppercase tracking-wider mb-4`}>
                GET IN TOUCH
              </span>
              <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-4">
                Freight Isn’t Just About Shipping.
                <br />
                <span className={theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'}>It’s About Growth.</span>
              </h2>
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className={`block text-xs font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'} mb-2`}>
                      FIRST NAME
                    </label>
                    <input
                      type="text"
                      placeholder="Ex. John"
                      className={`w-full px-4 py-3 ${theme === 'dark' ? 'bg-gray-700 text-white border-gray-600 focus:ring-emerald-500' : 'border-gray-300 focus:ring-emerald-500'} rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition`}
                    />
                  </div>
                  <div>
                    <label className={`block text-xs font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'} mb-2`}>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className={`w-full px-4 py-3 ${theme === 'dark' ? 'bg-gray-700 text-white border-gray-600 focus:ring-emerald-500' : 'border-gray-300 focus:ring-emerald-500'} rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition resize-none`}
                  ></textarea>
                </div>
                <div className="pt-2">
                  <Button
            ...
            <div className={`lg:w-1/2 ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-800'} flex items-center justify-center p-8`}>
